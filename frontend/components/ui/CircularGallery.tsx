...
class Media {
    ...
    onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
        ...
        if (viewport) {
            this.viewport = viewport;
            if ((this.plane.program.uniforms as Uniforms).uViewportSizes) {
                (this.plane.program.uniforms as Uniforms).uViewportSizes.value = [this.viewport.width, this.viewport.height];
            }
        }
...
class App {
    ...
    onWheel(e: Event) {
        ...
        const delta = wheelEvent.deltaY || (wheelEvent as unknown as { wheelDelta: number }).wheelDelta || (wheelEvent as unknown as { detail: number }).detail;
